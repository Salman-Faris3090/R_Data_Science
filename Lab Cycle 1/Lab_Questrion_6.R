...
if (choice == 1){
  ...
  start_range <- as.integer(readline(prompt = "Enter the initial number for the range: "))
  end_range <- as.integer(readline(prompt = "Enter the ending number for the range: "))
